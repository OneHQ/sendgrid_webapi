...
describe "#sub_user" do
  ...
  describe "#management", :vcr do
    it  "should add new subuser" do
      client.sub_user.management.add(:username => "chebyte", :website => "example.com", :password => "somepass", :confirm_password => "somepass",
                :first_name => "homero", :last_name => "simpson", :address => "555 anystreet", :city => "any city",
                :state => "CA", :zip => "91234", :email => "chebyte@example.com", :country => "US", :phone => "555-555").
        should == {"message"=>"success"}
    end
  
    it  "should get all subusers" do
      client.sub_user.management.get.
        should == [{"username"=>"chebyte", "email"=>"chebyte@example.com", "active"=>"true", "first_name"=>"homero", "last_name"=>"simpson", "address"=>"555 anystreet", "address2"=>"", "city"=>"any city", "state"=>"CA", "zip"=>"91234", "country"=>"US", "phone"=>"555-555", "website"=>"http://example.com", "website_access"=>"true"}]
    end
  
    it  "should disable sub_user for send email" do
      client.sub_user.management.disable(:user => "chebyte").
        should == {"message" => "success"}
    end    
    
    it  "should enable sub_user for send email" do
      client.sub_user.management.enable(:user => "chebyte").
        should == {"message" => "success"}
    end    
  
    it  "should enable sub_user for access to website" do
      client.sub_user.management.website_enable(:user => "chebyte").
        should == {"message" => "success"}
    end    
    
    it "should update sub_user" do
      client.sub_user.management.update(:user => "chebyte", :first_name => "change_named").
        should == {"message" => "success"}
    end
  end
  ...
  describe "#bounces", :vcr do
    it "should returns bounce emails" do
      client.sub_user.bounces.get(:user => "chebyte").
        should == []
    end
  
    it "should tries to delete unexisting bounce emails" do
      client.sub_user.bounces.delete(:user => "chebyte", :email => "test@test.com").
  ...
  describe "#unsubscribes", :vcr do
    it "should add bounce email" do
      client.sub_user.unsubscribes.add(:user => "chebyte", :email => "test@test.com").
        should == {"message"=>"success"}
    end
    
    it "should returns bounce emails" do
      client.sub_user.unsubscribes.get(:user => "chebyte").
        should == [{"email"=>"test@test.com"}]
    end
  
    it "should delete existing bounce email" do
      client.sub_user.unsubscribes.delete(:user => "chebyte", :email => "test@test.com").
        should == {"message"=>"success"}
    end
  ...
  describe "#spam", :vcr do
    it "should return spam mails" do
      client.sub_user.spam.get(:user => "chebyte").
        should == []
    end
  
    it "should tries to delete unexisting spam mail" do
      client.sub_user.spam.delete(:user => "chebyte", :email => "test@test.com").
        should == {"message"=>"Email does not exist"}
    end
  end
  ...
  describe "#invalid_emails", :vcr do
    it "should return invalid emails" do
      client.sub_user.invalid_emails.get(:user => "chebyte").
        should == []
    end
  
    it "should tries to delete unexisting invalid mail" do
      client.sub_user.invalid_emails.delete(:user => "chebyte", :email => "test@testr.com").
        should == {"message"=>"Email does not exist"}
    end
  end
  ...
  describe "#event_notification", :vcr do
    it "should add event notification url" do
      client.sub_user.event_notification.set(:user => "chebyte", :url => "www.example.com/notification").
        should == {"message"=>"success"}
    end
  
    it "should get event notification url" do
      client.sub_user.event_notification.get(:user => "chebyte").
        should == [{"url"=>"www.example.com/notification"}]
    end
  
    it "should delete event notification url" do
      client.sub_user.event_notification.delete(:user => "chebyte", :url => "www.example.com/noti.php").
        should == {"message"=>"success"}
    end
  end
  ...
  describe "#limits", :vcr do
    it "should set total credits" do
      client.sub_user.limits.set_credits(:user => "chebyte", :credits=> "200", :period=> "daily").
        should == {"message"=>"success"}
    end
    
    it "should returns limits for a sub user" do
      client.sub_user.limits.get(:user => "chebyte").
        should == [{"credit"=>"0", "credit_remain"=>"200", "last_reset"=>"2012-06-27"}]
    end
  
    it "should reset all limits for a sub user" do
      client.sub_user.limits.reset(:user => "chebyte", :credits=> "400", :period=> "daily").
        should ==  {"message"=>"success"}
      client.sub_user.limits.get(:user => "chebyte").
        should == [{"credit"=>"400", "credit_remain"=>"400", "last_reset"=>"2012-06-27"}]
    end
    ...
    it "should increments credits for a sub user" do
      client.sub_user.limits.increment_credits(:user => "chebyte", :credits=> "400").
        should == {"message"=>"success"}
      client.sub_user.limits.get(:user => "chebyte").
        should == [{"credit"=>"0", "credit_remain"=>"800", "last_reset"=>"2012-06-27"}]
    end
  
    it "should decrements credits for a sub user" do
      client.sub_user.limits.decrement_credits(:user => "chebyte", :credits=> "400").
        should == {"message"=>"success"}
      client.sub_user.limits.get(:user => "chebyte").
        should == [{"credit"=>"0", "credit_remain"=>"400", "last_reset"=>"2012-06-27"}]
    end
    
    it "should delete all limits for a sub user" do
      client.sub_user.limits.delete(:user => "chebyte").
        should == {"message"=>"success"}
      client.sub_user.limits.get(:user => "chebyte").
        should == []        
    end
  ...
  describe "#ip_management", :vcr do
    it "should return all ips available" do
      client.sub_user.ip_management.get(:user => "chebyte").
        should == [{"ip"=>"74.63.231.33"}]
    end
  
    it "should show ip subuser" do
      client.sub_user.ip_management.usage_ip(:user => "chebyte").
  ...
  describe "#monitor_records", :vcr do
    ...
    it "should add existing sub_user to monitor record" do
      client.sub_user.monitor_records.add_user(:user => "chebyte", :name => "testmonitor").
        should == {"message"=>"success"}
      client.sub_user.monitor_records.get.
        should == [{"name"=>"testmonitor", "email"=>"test@test.com", "frequency"=>"10", "users"=>["chebyte"]}]
    end
  
    it "should remove existing sub_user from monitor record" do
      client.sub_user.monitor_records.remove_user(:user => "chebyte", :name => "testmonitor").
        should == {"message"=>"success"}
      client.sub_user.monitor_records.get.
        should == [{"name"=>"testmonitor", "email"=>"test@test.com", "frequency"=>"10", "users"=>[]}]
    end
  ...
  describe "#authentication", :vcr do
    it "should auth a sub_user" do
      client.sub_user.auth.login(:user => "chebyte", :password => "somepass").
        should == {"message"=>"success"}
    end
  
    it "should return error with a bad sub_user" do
      client.sub_user.auth.login(:user => "chebyte", :password => "badpass").
  ...
  describe "#parse_email", :vcr do
    it "should set parse email" do
      client.sub_user.parse_email.set(:user => "chebyte", :hostname => "www.example.com", :url => "www.mydomain.com/parse.php", :spam_check => "1").
        should == {"message"=>"success"}
    end
    
    it "should get parse email" do
      client.sub_user.parse_email.get(:user => "chebyte").
        should == {"parse"=>[{"hostname"=>"www.example.com", "url"=>"www.mydomain.com/parse.php", "spam_check"=>1}]}
    end
  
    it "should delete parse email" do
      client.sub_user.parse_email.delete(:user => "chebyte", :hostname => "www.example.com").
        should == {"message"=>"success"}
      client.sub_user.parse_email.get(:user => "chebyte").
        should == {"parse" => []}          
    end
  ...
  describe "#apps", :vcr do
    it "should return available apps" do
      client.sub_user.apps.list(:user => "chebyte").
